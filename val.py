...
parser.add_argument('--number', type=str, default='1234', help='the number to generate')
...
number = opt.number #TODO: 写入你注册时绑定的手机号（字符串类型）
n_row = len(number)
...
Image.fromarray(np.uint8(img_array)).save("result"+str(number)+".png")
